        ...
        <div v-if="showFlag">
            <el-form :inline="true" :model="searchForm" class="form-content">
                <el-row :gutter="20" class="slt" :style="{justifyContent:contents.searchBoxPosition=='1'?'flex-start':contents.searchBoxPosition=='2'?'center':'flex-end'}">
                     ...
                     <el-form-item :label="contents.inputTitle == 1 ? '仓库管理员姓名' : ''">
                         <el-input prefix-icon="el-icon-search" v-model="searchForm.laoshiName" placeholder="仓库管理员姓名" clearable></el-input>
                     </el-form-item>
                ...
                <el-row class="ad" :style="{justifyContent:contents.btnAdAllBoxPosition=='1'?'flex-start':contents.btnAdAllBoxPosition=='2'?'center':'flex-end'}">
                    <el-form-item>
                        ...
                        <a style="text-decoration:none" class="el-button el-button--success"
                           ...
                           href="http://localhost:8080/cangkuguanlixitong/upload/laoshiMuBan.xls"
                        >批量导入仓库管理员数据模板</a>
                        &nbsp;
                        <el-upload
                                v-if="isAuth('laoshi','导入导出')"
    ...
    //当前表下拉框搜索条件
            ...
            json_fields: {
                ...
                //本表字段
                     '账户': "username",
                     '仓库管理员姓名': "laoshiName",
                     '仓库管理员手机号': "laoshiPhone",
                     '仓库管理员身份证号': "laoshiIdNumber",
                     '仓库管理员头像': "laoshiPhoto",
                     '性别': "sexValue",
                     '仓库管理员邮箱': "laoshiEmail",
                     '仓库管理员住址': "laoshiAddress",
            },
